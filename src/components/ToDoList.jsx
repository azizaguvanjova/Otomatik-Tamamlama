...
export default function ToDoList() {
  ...
  /* Challenge
    ...
    1. ClassName'i "new-item-input" olan text input focus'ta olduğunda, opacity 
	   className'i "add-item-icon" olan görselin className'ine "faded" class'ı eklenerek 0.2 olarak ayarlanmalıdır. 
     Input focus olmadığında ise bu class image'den kaldırılmalıdır.
    ...
    3. Kullanıcı "Otomatik Tamamla" butonuna tıkladığında, yapılacaklar listesi öğelerinin üzeri çizilirken onay kutularının 
    tümü aynı anda işaretlenmelidir. 
       
4. Bu görevleri tamamlamak için, bu yorumların altındaki kodda birkaç küçük değişiklik yapmanız gerekecektir. 
Ayrıca bu dosyaya birkaç küçük ekleme yapmanız gerekecektir. Bu eklemeleri nereye yapılması gerektiğini düşünüyorsanız oraya yapabilirsiniz.
 Kendinizi çok fazla kod değiştirirken veya eklerken bulursanız, işleri aşırı derecede karmaşık hale getiriyorsunuz demektir 
       
    Not: 24. satır ("Sizi İlgilendiren Bölüm" olarak işaretlenmiştir) ile bu yorumlar arasındaki kodu okumalısınız. 
    Bu kodun bazı yönleri bu görevleri tamamlamakla ilgilidir. Ancak, bu kod üzerinde herhangi bir değişiklik yapmanıza gerek yoktur.
     Sadece anlamanız gerekiyor
*/
